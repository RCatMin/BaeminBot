...
// POT_STATUS의 값들만 뽑아서 만든 타입. 'RECRUITING' | 'CLOSED' | 'SETTLING' | 'SETTLED'
...
const ALLOWED_TRANSITIONS: Record<PotStatus, PotStatus[]> = {
  RECRUITING: [POT_STATUS.CLOSED],
  CLOSED: [POT_STATUS.SETTLING],
  SETTLING: [POT_STATUS.SETTLED],
  SETTLED: [], // 마지막 단계라 더 갈 곳이 없습니다.
};
